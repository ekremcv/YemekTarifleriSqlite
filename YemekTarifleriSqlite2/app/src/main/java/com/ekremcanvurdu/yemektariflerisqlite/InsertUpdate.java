package com.ekremcanvurdu.yemektariflerisqlite;
...
public class InsertUpdate extends AppCompatActivity {
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (imageSelected == true && foodName.getText().toString().length() > 0 && foodRecipe.getText().toString().length() > 0 && foodIngredients.getText().toString().length() > 0) {
                    ...
                    Toast.makeText(InsertUpdate.this, "Lütfen Boşlukları Doldurun", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!getIntent().getStringExtra("event").equals("insert")) {
                    ...
                    Toast.makeText(InsertUpdate.this, "İlk yemeğinizi eklemelisiniz", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    public void delete() {
        ...
        Toast.makeText(InsertUpdate.this, "Yemek Silindi", Toast.LENGTH_SHORT).show();
    ...
    public void insertOrUpdate() {
        ...
        Toast.makeText(InsertUpdate.this, "Yemek Kaydedildi", Toast.LENGTH_SHORT).show();
        Intent intent = new Intent(InsertUpdate.this, MainActivity.class);
        startActivity(intent);
    }
}